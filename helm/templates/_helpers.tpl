...
{{- define "request-tracker.postgres.fullname" -}}
{{- if .Values.fullnameOverride }}
{{- printf "%s-postgres" .Values.fullnameOverride | trunc -63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.nameOverride }}
{{- if contains $name .Release.Name }}
{{- printf "%s-postgres" .Release.Name | trunc -63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s-postgres" .Release.Name $name | trunc -63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
